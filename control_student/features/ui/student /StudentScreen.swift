...
struct StudentScreen: View {
    ...
    var body: some View {
        NavigationView {
            ...
            .sheet(isPresented: $showPreview) {
                PreviewPhoto(manager: manager,
                             isSending: $isSending, sentSuccess: $sentSuccess,
                             showPreview: $showPreview) { screenshot in
                    Task {
                        isSending = true
                        await manager.confirmSelectionWithProfessor(screenshot: screenshot)
                        sentSuccess = true
                        isSending = false
                        showPreview = false
                    }
    ...
    private var actionFooter: some View {
        VStack {
            ...
            if sentSuccess {
                Label("Enviado! Aguarde o professor aprovar.", systemImage: "checkmark.circle.fill")
